...
bot = telebot.TeleBot('7933499154:AAFH6To3JgiPSFfjxrz4szxXJqyUmx3s_TQ')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @nitin_510."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @nitin_510")
...
Buy From :- @nitin_510
Official Channel :- https://t.me/LEGAL_KILLER0
'''
...
3. MAKE SURE YOU JOINED https://t.me/LEGAL_KILLER0 OTHERWISE NOT WORK
